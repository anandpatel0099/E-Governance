...
<script type="text/javascript">
	function CalltoDAOConfirm()
	{
		...
		document.getElementById("pmegp").submit();
	}
</script>
...
<form action="pmepServlet" method="post" name="pmegp" id="pmegp" >
...
<table width="956" height="308" style="width: 963px; border:solid; margin: 0 auto;">
    ...
    <tr align="center">
    	 <td height="43" colspan="9" style="height: 25px; padding-top: 0px !important; background-color:#CCC">
		 	<span style="color:black;font-weight: bold;">PRIME MINISTER'S EMPLOYMENT GENERATION PROGRAMME (PMEGP)</span></td>
   	</tr>
	...
	<tr>
		...
		<td width="17" style="font-weight: bold;">:</td>
		<td><input type="text" name="mthocc" id="mthocc" maxlength="250"/></td>
	  	<td></td>
	</tr>
	...
	<tr>
		...
		<td width="17" style="font-weight: bold;">:</td>
		<td><input type="text" name="sthocc" id="sthocc" maxlength="250"/></td>
	  	<td></td>
	</tr>
	...
	<tr>
		<td height="32">Address of proposed location of unit</td>
		<td width="17" style="font-weight: bold;">:</td>
		<td><input type="text" name="addloc" id="addloc" maxlength="250"/></td>
		<td height="32">District</td>
		<td width="17" style="font-weight: bold;">:</td>
		<td><input type="text" name="adis" id="adis" maxlength="250"/></td>
	  	<td colspan="2"></td>
	</tr>

	<tr>
		<td height="32">Whether Entrepreneur Development Programme undergone</td>
		<td width="17" style="font-weight: bold;">:</td>
		<td><input type="radio" name="chk1" id="chk1" value="yes"/>Yes</td>
	  	<td><input type="radio" name="chk1" id="chk1" value="no"/>No</td>
	</tr>
	<tr>
		<td height="32">Whether the project for</td>
		<td width="17" style="font-weight: bold;">:</td>
		<td><input type="radio" name="chk2" id="chk2" value="Manufacturing unit"/>Manufacturing unit</td>
	  	<td><input type="radio" name="chk2" id="chk2" value="Business/Service unit"/>Business/Service unit</td>
	</tr>
	<tr>
		<td height="32">Name of the project / business activity proposed</td>
		<td width="17" style="font-weight: bold;">:</td>
		<td><input type="text" name="nofpro" id="nofpro" maxlength="250"/></td>
	  	<td></td>
	</tr>
	<tr>
		<td height="32">Amount of loan required (in Rs.)</td>
		<td width="17" style="font-weight: bold;">:</td>
		<td><input type="text" name="loan" id="loan" maxlength="250"/></td>
	  	<td></td>
	</tr>
